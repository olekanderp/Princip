[
    ...
    },
    {
        ...
        "z": "1f738e06.33c862",
        "name": "",
        "url": "/api/platform/first/getWeight",
        "method": "get",
        "upload": false,
        "swaggerDoc": "",
        "x": 170,
    ...
    },
    {
        ...
        "z": "1f738e06.33c862",
        "name": "FAST WEIGHT",
        "func": "msg.payload = {\n    weight: flow.get('currentWeight'),\n    status:true,\n    stable:true,    \n    perimetr:true,\n    duration:flow.get('time_end')-flow.get('time_start')+1000\n\n}\nreturn msg;\n",
        "outputs": 1,
        "noerr": 0,
        "x": 460,
        "y": 920,
    ...
    },
    {
        ...
        "type": "function",
        "z": "1f738e06.33c862",
        "name": "MAKE SOCKET PAGE",
        "func": "return msg;",
        "outputs": 1,
        "noerr": 0,
        "x": 747.9999694824219,
        "y": 215.42856693267822,
        "wires": [
            []
        ]
    },
    ...
    },
    {
        ...
        "z": "1f738e06.33c862",
        "name": "",
        "group": "8a4e46f9.d0588",
        "order": 2,
        "width": 0,
        "height": 0,
        "label": "Графік за останні 5 хвилин",
        "chartType": "line",
        "legend": "false",
        "xformat": "HH:mm:ss",
        "interpolate": "linear",
    ...
    },
    {
        ...
        "z": "1f738e06.33c862",
        "name": "Модель весов",
        "func": "flow.set('inputString', String.fromCharCode(0x02) + String.fromCharCode(0x41) + String.fromCharCode(0x03)); //тут пишем строку, которую шлем в ком порт, при необходимости\nflow.set('parser',function(v){ \n        //тут парсим строку, которая приходит с весовго модуля\n       v = v.substring(1, 8);\n       return Number(v);\n      \n        }\n  );\nreturn msg;",
        "outputs": 1,
        "timeout": "",
        "noerr": 0,
        "initialize": "",
    ...
    },
    {
        ...
        "once": false,
        "topic": "",
        "payload": "arrayOfWeights",
        "payloadType": "flow",
        "x": 119.00000381469727,
        "y": 1064.4286003112793,
        "wires": [
            [
                "a71f7812.dfe438"
            ]
    ...
    },
    {
        ...
        "type": "switch",
        "z": "1f738e06.33c862",
        "name": "Logging direction",
        "property": "log_direction",
        "propertyType": "msg",
        "rules": [
            {
                "t": "eq",
    ...
    },
    {
        ...
        "type": "function",
        "z": "1f738e06.33c862",
        "name": "Запис дати з потку від ВесПроц",
        "func": "flow.set('dateFromSerial', Date.now());\n\nreturn msg;",
        "outputs": 1,
        "noerr": 0,
        "x": 300.1763916015625,
        "y": 599.1997499465942,
    ...
    },
    {
        ...
        "type": "function",
        "z": "1f738e06.33c862",
        "name": "Запис дати в NODE-Red",
        "func": "flow.set('dateFromNode',Date.now());\n\nreturn msg;",
        "outputs": 1,
        "noerr": 0,
        "x": 273.16239166259766,
        "y": 650.718147277832,
        "wires": [
            []
        ]
    ...
    },
    {
        ...
        "height": 0,
        "name": "",
        "label": "Скільки немає зв'язку,с",
        "format": "{{msg.payload}}",
        "layout": "row-spread",
        "x": 1055.4957275390625,
        "y": 674.0041160583496,
        "wires": []
    },
    {
    ...
    },
    {
        ...
        "height": 0,
        "name": "",
        "label": "Час тривалості зважування, с",
        "format": "{{msg.payload}}",
        "layout": "row-spread",
        "x": 1160.91650390625,
        "y": 514.7748050689697,
    ...
    },
    {
        ...
        "type": "comment",
        "z": "1f738e06.33c862",
        "name": "Control Status setting",
        "info": "",
        "x": 264.28572845458984,
        "y": 540.0000343322754,
        "wires": []
    },
    {
    ...
    },
    {
        ...
        "z": "1f738e06.33c862",
        "name": "MAKE BODY",
        "func": "msg.payload = {\n  \"success\": true,\n  \"message\": \"You have successfully logged in!\",\n  \"token\": \"eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9.eyJzdWIiOiJ1c2VyIiwiaWF0IjoxNjkyODgzMzI1fQ.cBCPVvnRKQLdbvYZQF0uE9sKw5LMUGTE2Vgl37n1Wa8\",\n  \"user\": {\n    \"name\": \"user\",\n    \"role\": \"user\"\n  }\n}\nreturn msg;\n",
        "outputs": 1,
        "timeout": "",
        "noerr": 0,
        "initialize": "",
    ...
    },
    {
        "id": "b8239e53.584268",
        "type": "ui_group",
        "name": "Поточний стан контрольних точок",
        "tab": "e16b43b8.c4d038",
        "order": 2,
        "disp": true,
        "width": "3"
